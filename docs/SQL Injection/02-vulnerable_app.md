...
<div class="mb-3"><img src="{% static 'assets/img/login2.png' %}" class="col-6 mx-auto" alt=""></div>
...
<div class="mb-5"><img src="{% static 'assets/img/login3.png' %}" alt="" class="col-6 mx-auto"></div>
<div class="my-3">
